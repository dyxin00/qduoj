...
DATABASES = {
    'default': {
        'ENGINE': 'dojango.db.backends.mysql', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
...
# in apps' "static/" subdirectorie and in STATICFILES_DIRS.
...
SECRET_KEY = 'u=&4&t_)=8_iepnldvz)udy6k86f%crip31yuiww&#dabkj)h5'
